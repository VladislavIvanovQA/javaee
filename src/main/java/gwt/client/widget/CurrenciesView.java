...
public class CurrenciesView extends Composite {
    @UiTemplate("CurrenciesViewPart.ui.xml")
    public interface CurrenciesViewUIBinder extends UiBinder<FlowPanel, CurrenciesView> {
    }

    private static CurrenciesViewUIBinder ourUiBinder = GWT.create(CurrenciesViewUIBinder.class);
